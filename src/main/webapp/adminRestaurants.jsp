	...
	<div class="admin-section" id="restaurants">
			...
			<table border="1">
				...
				<tbody>
					...
					<tr>
						...
						<td><%=r.getRating()%></td>
						<td>$<%=String.format("%.2f", r.getRestaurant_price())%></td>
					</tr>
					<%
					}
					%>
		...
		<div class="container">
			...
			<form action="restaurantServlet" method="post">
				...
				<input type="text" name="description" placeholder="Description / Address" required> 
				...
				<input type="number" step="0.01" name="restaurant_price" placeholder="Average Price per Person" required>
		...
		<div class="container">
			...
			<form action="restaurantServlet" method="post">
				...
				<input type="number" name="restaurant_id" placeholder="Restaurant ID to Update" required> 
				<input type="text" name="name" placeholder="New Restaurant Name" required> 
				<input type="text" name="description" placeholder="New Description / Address" required> 
				<input type="text" name="cuisine_type" placeholder="New Cuisine Type" required> 
				<input type="number" step="0.1" name="rating" placeholder="New Rating" required> 
				<input type="number" step="0.01" name="restaurant_price" placeholder="New Average Price per Person" required>
		...
		<div class="container">
			...
			<form action="restaurantServlet" method="post">
				...
				<input type="number" name="restaurant_id" placeholder="Restaurant ID to Delete" required> 
