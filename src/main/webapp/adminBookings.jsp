	...
	<div class="admin-section" id="bookings">
		...
		<div class="container">
			...
			<form action="bookingServlet" method="post">
				...
				<input type="number" name="user_id" placeholder="Tourist ID" required>
				<input type="number" name="destination_id" placeholder="Destination ID (optional, 0 if not applicable)" value="0">
				<input type="number" name="resort_id" placeholder="Resort ID (optional, 0 if not applicable)" value="0">
				<input type="number" name="restaurant_id" placeholder="Restaurant ID (optional, 0 if not applicable)" value="0">
				<input type="number" name="itinerary_id" placeholder="Itinerary ID (optional, 0 if not applicable)" value="0">
				<input type="date" name="booking_date" required> 
				<input type="text" name="status" placeholder="Status (e.g., Pending, Confirmed)" required> 
		...
		<div class="container">
			...
			<form action="bookingServlet" method="post">
				...
				<input type="number" name="booking_id" placeholder="Booking ID to Update" required> 
				<input type="number" name="user_id" placeholder="New Tourist ID" required> 
				<input type="number" name="destination_id" placeholder="New Destination ID (optional, 0 if not applicable)" value="0">
				<input type="number" name="resort_id" placeholder="New Resort ID (optional, 0 if not applicable)" value="0">
				<input type="number" name="restaurant_id" placeholder="New Restaurant ID (optional, 0 if not applicable)" value="0">
				<input type="number" name="itinerary_id" placeholder="New Itinerary ID (optional, 0 if not applicable)" value="0">
				<input type="date" name="booking_date" required> 
				<input type="text" name="status" placeholder="New Status (e.g., Pending, Confirmed)" required> 
		...
		<div class="container">
			...
			<form action="bookingServlet" method="post">
				...
				<input type="number" name="booking_id" placeholder="Booking ID to Delete" required> 
