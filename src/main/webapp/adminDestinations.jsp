	...
	<div class="admin-section" id="destinations">
		...
		<div class="container">
			...
			<table>
				...
				<tbody>
				<%
				DestinationImplementation di = new DestinationImplementation(); // Corrected instantiation
				...
				%>
					<tr>
						...
						<td>$<%=String.format("%.2f", destination.getDestination_price())%></td>
						<td><img src="<%=destination.getDestination_image()%>" alt="Destination Image" width="100"></td>
		...
		<div class="container">
			...
			<form action="destinationServlet" method="post">
				...
				<input type="text" name="destination_description" placeholder="Short Description" required>
				<textarea name="destination_paragraph" placeholder="Paragraph about the destination" rows="4" required></textarea>
				<input type="number" step="0.01" name="destination_price" placeholder="Price per day" required> 
				<input type="text" name="destination_image" placeholder="Image Path (e.g., Images/Munnar_photo.jpg)" required>
				<input type="text" name="destination_rating" placeholder="Rating (e.g., 4.5 stars)" required> 
		...
		<div class="container">
			...
			<form action="destinationServlet" method="post">
				...
				<input type="number" name="destination_id" placeholder="Destination ID to Update" required> 
				<input type="text" name="destination_name" placeholder="New Destination Name" required> 
				<input type="text" name="destination_description" placeholder="New Short Description" required>
				<textarea name="destination_paragraph" placeholder="New Paragraph about the destination" rows="4" required></textarea>
				<input type="number" step="0.01" name="destination_price" placeholder="New Price per day" required> 
				<input type="text" name="destination_image" placeholder="New Image Path (e.g., Images/Munnar_photo.jpg)" required>
				<input type="text" name="destination_rating" placeholder="New Rating (e.g., 4.5 stars)" required> 
		...
		<div class="container">
			...
			<form action="destinationServlet" method="post">
				...
				<input type="number" name="destination_id" placeholder="Destination ID to Delete" required> 
