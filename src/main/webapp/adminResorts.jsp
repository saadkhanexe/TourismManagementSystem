	...
	<div class="admin-section" id="resorts">
			...
			<table border="1" cellpadding="8" cellspacing="0">
				...
				<tbody>
					...
					<tr>
						...
						<td><%=r.getType()%></td>
						<td><%=r.getRating()%></td>
						<td>$<%=String.format("%.2f", r.getResort_price())%></td>
		...
		<div class="container">
			...
			<form action="resortServlet" method="post">
				...
				<input type="text" name="type" placeholder="Type (e.g., Luxury, Budget)" required> 
				<input type="number" name="rating" step="0.1" placeholder="Rating (e.g., 4.5)" required>
				<input type="number" step="0.01" name="resort_price" placeholder="Price per Night" required>
		...
		<div class="container">
			...
			<form action="resortServlet" method="post">
				...
				<input type="number" name="resort_id" placeholder="Resort ID to Update" required> 
				<input type="text" name="name" placeholder="New Resort Name" required> 
				...
				<input type="number" name="rating" step="0.1" placeholder="New Rating" required> 
				<input type="number" step="0.01" name="resort_price" placeholder="New Price per Night" required> 
		...
		<div class="container">
			...
			<form action="resortServlet" method="post">
				...
				<input type="number" name="resort_id" placeholder="Resort ID to Delete" required> 
